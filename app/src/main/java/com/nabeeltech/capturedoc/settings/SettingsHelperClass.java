...
public class SettingsHelperClass {
    ...
    static ImageProcessorConfiguration getImageProcessorConfiguration(Context context) {
        ...
        switch (deskewTypeStr) {
            case "None":
                imageProcessorConf.deskewType = ImageProcessorConfiguration.DeskewType.DESKEW_NONE;
                break;
            case "ByDocumentEdges":
                imageProcessorConf.deskewType = ImageProcessorConfiguration.DeskewType.DESKEW_BY_DOCUMENT_EDGES;
                break;
            case "ByDocumentContent":
                imageProcessorConf.deskewType = ImageProcessorConfiguration.DeskewType.DESKEW_BY_DOCUMENT_CONTENT;
                break;
        }
        ...
        if ((!prefs.contains("pref_key_image_processing_auto_rotate") && DefaultSettings.pref_key_image_processing_auto_rotate) ||
            ...
            imageProcessorConf.rotateType = ImageProcessorConfiguration.RotateType.ROTATE_AUTO;
        }
        ...
        if ((!prefs.contains("pref_key_image_processing_auto_crop") && DefaultSettings.pref_key_image_processing_auto_crop) ||
            ...
            imageProcessorConf.cropType = ImageProcessorConfiguration.CropType.CROP_AUTO;
        }
        ...
        switch (imageProcessingModeStr) {
            case "BW":
                imageProcessorConf.outputColorDepth = ImageProcessorConfiguration.ColorDepth.BITONAL;
                break;
            case "Gray":
                imageProcessorConf.outputColorDepth = ImageProcessorConfiguration.ColorDepth.GRAYSCALE;
                break;
            case "Color":
                imageProcessorConf.outputColorDepth = ImageProcessorConfiguration.ColorDepth.COLOR;
                break;
        }
    ...
    public static void initRestrictionPropertiesFields(SharedPreferences prefs)
    {
